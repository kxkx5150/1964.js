...
(function() {
  ...
  C1964jsPif = class C1964jsPif {
    ...
    processPif() {
      ...
      if ((this.pifUint8Array[pifRamStart] === 0xff) && (this.pifUint8Array[pifRamStart + 1] === 0xff) && (this.pifUint8Array[pifRamStart + 2] === 0xff) && (this.pifUint8Array[pifRamStart + 3] === 0xff)) { //see iPif.cpp. the first 4 dwords will be -1, not just the first 4 bytes. Make pifUint32Array and use it 4 times.
